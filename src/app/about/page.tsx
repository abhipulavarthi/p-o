...
const techLogos = [
    ...
    { node: <SiSass className="text-[#CC6699]" />, title: "SCSS" },
    ...
    { node: <SiThreedotjs className='text-white' />, title: "Three.js" },
    { node: <SiGreensock className="text-[#88CE02]" />, title: "GSAP" },
                    ...
                    >
                        <div className="flex flex-col h-full justify-between">
                            <div>
                                ...
                                <div className="mt-8 space-y-4 text-base md:text-lg leading-relaxed text-white/60">
                                    <p>
                                        Passionate and versatile Full Stack Developer with a strong interest in frontend design, modern web development, and creating engaging digital experiences. Skilled in building responsive and user-friendly websites while continuously exploring new technologies, frameworks, and creative solutions.
                                    </p>
                                    <p>
                                        Enthusiastic about UI/UX design, problem-solving, and developing innovative projects that combine functionality with aesthetics. Quick learner with a growth mindset, strong adaptability, and a keen interest in expanding knowledge across software development, design, and emerging tech trends.
                                    </p>
                                </div>
                            </div>
